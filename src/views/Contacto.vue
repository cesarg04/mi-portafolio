...
<template>
  <div class="px-10 md:px-2 md:grid md:grid-cols-2 mt-20">
    <div class="shadow-lg w-full px-10 pb-10">
      <h1 class="font-rubik font-semibold text-2xl">Contacto</h1>
      <form action="" role="form" method="POST" @submit.prevent="sendEmail">
        ...
        <div class=".divsdivisors">
            <label for="subject" class="labels">Asunto</label>
            <input type="text" v-model="asunto" class="inputs" required>
        </div>

        <div class=".divsdivisors">
            <label for="message" class="labels">Mensaje</label>
            <textarea v-model="mensaje" name="message" id="" cols="14" rows="6" class="bg-inputsbg w-full font-rubik text-lg"></textarea>
        </div>
    ...
    <div class="mt-16 md:mt-2 md:mx-10">
        <h1 class="font-rubik text-2xl font-semibold">Detalles de contacto</h1>
        <div class="mt-4">
            <div class="flex items-center my-2">
                <Icon icon="akar-icons:location" class="text-lg" />
                <h1 class="h1contact">Santo Domingo, Republica Dominicana.</h1>
            </div>

            <div class="flex items-center my-2">
                <Icon icon="carbon:email" class="text-lg"/>
                <h1 class="h1contact">elduro2002_@hotmail.com</h1>
            </div> 

            <div class="flex items-center my-2">
                <Icon icon="bi:telephone" class="text-lg"/>
                <h1 class="h1contact">+1 829-744-1835</h1>
            </div>
...
<style scoped>
.inputs{
    @apply w-full px-5 py-2 border-0 rounded-md shadow-sm bg-inputsbg font-rubik text-lg
}
.divsdivisors{
    @apply mb-10
}
